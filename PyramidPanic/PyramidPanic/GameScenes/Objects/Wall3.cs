...
{//hiermee beloofd wall3 om zich te houden aan de wetten en regels van IStaticObject
    public class Wall3 : IStaticObject
    {
        //fields
        private Rectangle collisionrect;
        private Texture2D image;
        //constructor
        public Wall3(int X, int Y, Texture2D image)
        {
